    ...
    <AdminLayout>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage newsletter subscribers, verify emails, and track subscriptions.</p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <div className="relative flex-1 max-w-sm">
          ...
          <Input placeholder="Search emails..." className="pl-9 bg-card/50 border-border/50" />
        </div>
